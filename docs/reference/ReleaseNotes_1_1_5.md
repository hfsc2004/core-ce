...
This release focuses on PSF Terminal's existing RLM document-assist routing, especially when the active local backend is llama.cpp. This is not a full implementation of the MIT Recursive Language Model design.

## Highlights

1. Document-assist routing for llama.cpp terminals
- RLM document-assist requests now run before backend streaming.
...
2. Existing RLM document-assist engine regression tests passed.
