      ...
      <aside class="ct-settings-drawer" role="dialog" aria-modal="true" aria-label="Quick Settings">
        ...
        <div class="ct-modal-body">
          <div class="ct-settings-list">
            ...
            <div class="ct-settings-row"><button class="ct-btn ct-btn-small ct-settings-state-btn" id="ct-settings-rlm"></button><span class="ct-settings-item">RLM Assist</span><span class="ct-settings-desc">Use the current partial RLM document-assist scaffold for long-document intents. (Recommended On)</span></div>
