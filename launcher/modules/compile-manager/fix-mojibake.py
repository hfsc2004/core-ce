...
PATTERNS = [
    ...
    # NEW patterns - Round 10
    ("c3a2e28094e280b9", "\u25CB"),                       # ○ white circle
    # NEW patterns - Round 11 (box drawing characters)
    ("c3a2e280a2e2809d", "\u2554"),                       # ╔ double down and right
    ("c3a2e280a2e28094", "\u2557"),                       # ╗ double down and left
    ("c3a2e280a2c290", "\u2550"),                         # ═ double horizontal
    ("c3a2e280a2e28098", "\u2551"),                       # ║ double vertical
    ("c3a2e280a2c2a3", "\u2563"),                         # ╣ double vertical and left
    ("c3a2e280a2c29d", "\u255D"),                         # ╝ double up and left
    # NEW patterns - Round 12
    ("c3a2e280a2c2a0", "\u2560"),                         # ╠ double vertical and right
    # NEW patterns - Round 13
    ("c3a2e280a2c5a1", "\u255A"),                         # ╚ double up and right
